...
class Review(models.Model):
    ...
    creator = models.ForeignKey(User, related_name="sneaker_reviews", on_delete=models.CASCADE)
    sneaker = models.ForeignKey(Sneaker, related_name="reviews", on_delete=models.CASCADE)
